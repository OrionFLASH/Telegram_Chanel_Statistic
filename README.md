...
**Решенные проблемы:**
- Возможность запускать программу только для скачивания фотографий без полного сканирования
- Оптимизация времени работы при необходимости только статистики или только фотографий
