...
5. Результаты будут сохранены в каталог `OUT/` с таймштампом `YYYYMMDD_HHMM`:
   - `OUT/channels_data_YYYYMMDD_HHMM.xlsx` - форматированный файл Excel
6. В консоли будет выведена итоговая статистика по каналам и личным чатам, включая:
